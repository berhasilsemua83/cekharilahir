...
const StartScreen: React.FC<{ onStart: () => void }> = ({ onStart }) => (
  // ✅ PERUBAHAN: Membuang md:justify-center dan memakai justify-start untuk semua perangkat.
  // pt-6 untuk HP, pt-12 untuk PC agar posisinya aman di atas dan tidak terpotong di bawah.
  <div className="flex flex-col items-center justify-start pt-6 md:pt-12 min-h-screen p-4 text-center max-w-2xl mx-auto fade-in">
    ...
    <div className="mb-3 md:mb-6 p-3 md:p-4 bg-slate-800 rounded-full ring-4 ring-indigo-500/20 shadow-2xl shadow-indigo-500/10">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 md:h-14 md:w-14 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
      </svg>
    </div>
    
    <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-white mb-2 md:mb-5 tracking-tight leading-tight md:leading-tight">
